...
import { Layout, Socials } from '../components';
          ...
          <Layout>
            ...
            <section className='px-4 pt-12'>
              <header className='flex mb-6'>
                ...
                <h2 className='pl-5 text-2xl font-bold text-white'>{translations.about.title}</h2>
              </header>

              <article className='font-sans leading-relaxed md:pl-6'>

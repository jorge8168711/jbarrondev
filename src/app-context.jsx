      ...
      content: (
        <>
          ...
          <p className='mb-4'>
            ...
            Web. Esta oportunidad me abrió el camino para convertir todo lo que había aprendido por
            mi cuenta en una profesión que hasta ahora me ha permitido aprender día a día y
          ...
          <ul className='pl-6 list-disc list-inside'>
            <li className='mb-4'>
              <strong className='fw-bold'>Maquetación: </strong>He sido responsable de maquetar
              sitios web responsive, aplicaciones web o plantillas para los diferentes clientes de
              correo electrónico utilizando tecnologías como
              ...
              tiempo mis skills mejoraron y me permitieron tomar la resposabilidad de todas las
              actividades relacionadas con el desarrollo Front-end de los proyectos.
            </li>
            <li className='mb-4'>
  ...
  en: {
    ...
    about: {
      ...
      content: (
        <>
          <p className='mb-4'>
            Hello my name is Jorge and I&apos;m a Front-end developer. I have been developing
            professionally for more than 4 years. I started my career as a developer only as a hobby
            because I always had an interest in programming and technology, so as soon as I had the
            a chance I decided to focus on learn everything I could about it.
          </p>
          <p className='mb-4'>
          ...
          <ul className='pl-6 list-disc list-inside'>
            <li className='mb-4'>
              <strong className='fw-bold'>Layout: </strong> I&apos;ve been responsable for the
              layout for responsive websites, web applications and email templates for the different
              email clients with technologies such as <strong className='text-yellow'>CSS </strong>{' '}
              and <strong className='text-yellow'>HTML5</strong>, during my beginnings I was only
